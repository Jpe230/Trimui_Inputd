...
/**
 * Initialize the Smart Pro device, configure serial ports, and prepare state.
 *
...
/**
 * Poll Smart Pro serial endpoints and emit uinput events.
 *
 * @param ctx Device context provided by smart_pro_init.
 * @return true to continue processing; false on fatal error.
 */
bool smart_pro_poll(void *ctx);

/**
 * Close Smart Pro serial endpoints and release resources.
 *
 * @param ctx Device context provided by smart_pro_init.
 * @return void.
 */
